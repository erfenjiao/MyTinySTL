...
namespace mystl
{
    ...
    template<class RandonIter , class Distance>
    void push_heap_d(RandonIter first , RandonIter last , Distance*)
    {
        mystl::push_heap_aux(first , (last - first)-1 , static_cast<Distance>(0) , *(last-1));
    }

    template<class RandonIter>
    void push_heap(RandonIter first , RandonIter last)
    {
    ...
    */
   template<class RandonIter , class Distance , class T>
   void adjust_heap(RandonIter first , Distance holeIndex , Distance len , T value)
   {
